...
func init() {
	...
	/*
		numCgoCallDerive := instruments.NewDerive(runtime.NumCgoCall())
		runtimeMap.Set("CgoCallRate", expvar.Func(func() interface{} {
			numCgoCallDerive.Update(runtime.NumCgoCall())
			return int64(numCgoCallDerive.Snapshot())
		}))*/
